...
![Logo](https://github.com/amit873/LangGraph_Code/blob/main/banner.png)
...
|--------|------------------|-----------|
| **project/agentic-rag** | Advanced RAG pipeline with grading, web-search & adaptive routing | [link](https://github.com/amit873/LangGraph_Code/tree/project/agentic-rag) |
| **project/ReAct-agent** | Classic ReAct (Reason + Act) agent in LangGraph | [link](https://github.com/amit873/LangGraph_Code/tree/project/ReAct-agent) |
| **project/reflection** | Minimal reflection demo – the *why* before the *wow* | [link](https://github.com/amit873/LangGraph_Code/tree/project/reflection) |
| **project/reflection-agent** | Full reflection agent that revises its own output | [link](https://github.com/amit873/LangGraph_Code/tree/project/reflection-agent) |
| **project/reflexion-agent** | Reflexion agent that learns from past runs | [link](https://github.com/amit873/LangGraph_Code/tree/project/reflexion-agent) |
...
```bash
# 1. Clone & enter
$ git clone https://github.com/amit873/LangGraph_Code.git
$ cd langgaph-course
